    ...
    <div className="mt-5 flex gap-2">
      <div className="md:h-[200px] h-[150px] cursor-pointer relative rounded-lg bg-white md:w-32 w-24">
        ...
        <div>
          ...
          <p className="md:text-[12px] text-[10px] text-center mt-4">Create story</p>
        </div>
      </div>

      <div className="md:h-[200px] h-[150px] cursor-pointer overflow-hidden relative rounded-lg md:w-32 w-24">
        <img
